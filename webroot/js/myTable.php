...
header("Content-type: application/javascript");
  ?>
         var nameImageFighter = "<?php echo '/WebArenaGoupSIA-00-00%20-%20Copie/WebArenaGoupSIA-00-00/img/pomme.jpg' ?>";
        var addBlockImg = '<img id = "image" ' + "src=" + nameImageFighter +  '>' + '</img>';
...
$('tbody').children('tr').children('th').addClass("setSize");
	...
	$('tbody').children("tr:nth-child("+radom_y+")").children("th:nth-child("+(radom_x)+")").append(addBlockImg);
