    ...
    <body>        
        ...
        <article id="move_fighter"> 
            ...
            <form id="Fightermove" method="get">
                <fieldset>
                    <label> Indicate the direction to move </label>
                    <?php
        ...
        <article id="move_to_next_level">
            ...
            <form id="MovetotheNextLevel" method="get">
                <fieldset> 
                    <label> Indicate the number of level to increment </label>
                    <?php                
                    ...
                    $.get(                         
                        ...
                        function(json) {                                                        
                            $.each(json,function(i,item){
                                //alert(i +'=>' + item);
                                $("#track_ennemy").show(); // affiche la liste des ennemis dans une liste déroulante
